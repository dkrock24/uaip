...
function select()
{
	$sql = "select * from sr_pdefuncion";
	$statement = mysql_query($sql)or die(mysql_error(). " Erro al cargar las partidas de defuncion");
	return $statement;
}

function selectDetalle($id_partida)
{
	$sql = "select * from sr_pdefuncion where id_partida='".$id_partida."'";
