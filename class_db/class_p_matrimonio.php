...
function select()
{
	$sql = "select * from sr_pmatrimonio";
...
{
	$sql = "select * from sr_pmatrimonio where id_pmatrimonio='".$id_partida."'";
	$statement = mysql_query($sql)or die(mysql_error(). " Erro al cargar la partida de matrimonio por ID");
	$row = mysql_fetch_array($statement);
	return $row;
}
