...
class info_model extends CI_Model
{
    ...
    public function setInfo()
    {
        if($_POST['nombreImagen']!=""){
            $data = array(
                'nombre_empresa' => $_POST['nombreInstitucion'],
                'rubro_empresa' => $_POST['rubroInstitucion'],
                'logo_empresa' => $_POST['nombreImagen'],
                'pais' => $_POST['paisInstitucion'],
                'departamento' => $_POST['departamentoInstitucion'],
                'municipio' => $_POST['municipioInstitucion'],
                'telefono' => $_POST['telefonoInstitucion'],
                'fax' => $_POST['faxInstitucion'],
                'nit' => $_POST['nitInstitucion'],
                'nombre_alcalde' => $_POST['nombre_alcaldeInstitucion'],
                'nombre_secretario' => $_POST['nombre_secretarioInstitucion'],
                'jefe_registro_familiar' => $_POST['nombre_secretario2Institucion']
            );
        }else{
            $data = array(
            'nombre_empresa' => $_POST['nombreInstitucion'],
        ...
        $this->db->update(self::sr_empresa, $data);   
        //echo $this->db->queries[0];   
    }
}
/*
