...
var fechadeldia = f.getDate()+""+(f.getMonth()+1)+""+f.getFullYear()+""+f.getHours()+""+f.getMinutes()+""+f.getSeconds();
    $(document).ready(function(){
        ...
        $('#fleImagen2').change(function(){ 
                var tmppath = URL.createObjectURL(event.target.files[0]);
                $("#preview2").fadeIn("low").attr('src',URL.createObjectURL(event.target.files[0]));
    ...
    $("#updateEntrada").click(function(){
            var filename2 = $("#fleImagen2").val().replace(/C:\\fakepath\\/i, '');
            var fileDocument1 = $("#documento1").val().replace(/C:\\fakepath\\/i, '');

            var formData = new FormData();
            formData.append('file', $('#fleImagen2')[0].files[0]);
            ...
            if(filename2!=""){
                $("#nombreImagen2").val(fechadeldia+filename2);
...
<table class="table table-bordered table-striped">  
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <input type="file" class="form-control" name="fleImagen2" id="fleImagen2" multiple>
                    <img src="../../../assets/images/avatars/<?php echo $entrada->imagen; ?>" id="preview2" width='100px'>
                </div>
            </div>
        </div>
    </div>
    ...
    <input type="hidden" name="nombreImagen2" id="nombreImagen2" value="">
