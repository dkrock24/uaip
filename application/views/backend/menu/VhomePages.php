	    	...
	    	<form action="post" name="home_menu" id="home_menu">
	    		<table class='table'>
	    			...
	    			<tr >
	    				<td>Class Menu</td>
	    				<td>
	    					<input type='text' name='class_menu' value="null" id='class_menu' readonly="true">
	    				</td>
	    			...
	    			<tr >
	    				<td>Seccion Menu</td>
	    				<td>
	    					<select name='seccion' id='menuPadre' class="form-control">
	    			...
	    			<tr >
	    				<td>Pagina</td>
	    				<td>	 
	    					<input type='text' name='pages' id='pages' value="uaip">  					
	    				</td>
	    			...
	    			<tr >
	    				<td>Estado</td>
	    				<td>
	    					<select name='estado_menu' id='menuPadre' class="form-control">
	    	...
	    	<form action="post" name="home_submenu" id="home_submenu">
	    		<table class='table'>
	    			...
	    			<tr >
	    				<td>Mostrar Como:</td>
	    				<td>	    					
	    					<select name="url_submenu" id='url_submenu' class="form-control">
	    						<option value="uaip/Cinicio/index">1 Publicación</option>
	    						<option value="uaip/Cinicio/valores">1 a 3 Publicaciones</option>
	    						<option value="uaip/Cproyecto/index">Lista de Publicaciones</option>
	    						<option value="uaip/Cinicio/dibujo">Imagen</option>
	    					</select>
	    				</td>	    				
	    			</tr>
	    			<tr >
