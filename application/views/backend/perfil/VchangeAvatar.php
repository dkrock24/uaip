...
<input type="hidden" value="<?php echo $_SESSION['idUser'][0]; ?>" name="idusuario" id="id_usuario">
                  ...
                  <span class="input input--hoshi">
                    ...
                    <table>
                     ...
                     foreach ($avatar as $avatars)                     
                     {
                      ...
                      ?>
                        <div class='avatar'>
                          <img class='ddd' src="<?php echo $path.$avatars->url_avatar; ?>" width="50px">
                          <input type="radio" class="avatar" name="avatar" id="<?php echo $avatars->url_avatar; ?>">
                        </div>
                      <?php                      
                      }
...
<!--
                    ...
                    -->
                      ...
                      <?php
                        $path = '../../../assets/images/avatars/';
                        foreach ($avatarPersonal as $avatarPersonales) {

                      ?>
                        <div class='avatar'>
                          <img src="<?php echo $path.$avatarPersonales->url_avatar; ?>" width="50px">
                          <input type="radio" class="avatar" name="avatar" id="<?php echo $avatarPersonales->url_avatar; ?>">
                        </div>
                      <?php                      
                      }
                     ?>
    ...
    <div class="row">
        ...
        <div class="col-md-10"></div>
        <div class="col-md-2">
            <button class='btn btn-primary' id="cambiarAvatar">Cambiar Avatar</button>
        </div>
    </div>
</div>
