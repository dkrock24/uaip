$(function() {
    if($('body').data('page') == 'login'){
        ...
        $('#submit-form, #submit-password').click(function(e) {
            ...
            l.start();
            setTimeout(function() {
                window.location.href = "validation/autentificar.php";
            }, 2000);
        });
        ...
        $('#image-cb').load(function() {
            if ($('#image-cb').is(":checked")) {
                $.backstretch(["assets/images/gallery/login_1.jpg"], {
                    fade: 600,
                    duration: 4000
                });
         ...
         if( $('#slide-cb').attr('checked') ) {
            if ($('#slide-cb').is(":checked")) 
            {
                $.backstretch(["../../../assets/images/gallery/login_1.jpg",
                                "../../../assets/images/gallery/login_2.jpg", 
                                "../../../assets/images/gallery/login_3.jpg", 
                                "../../../assets/images/gallery/login_4.jpg", 
                                "../../../assets/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
                });
        ...
        $('body').load(function() {
            if ($('#slide-cb').is(":checked")) 
            {
                $.backstretch(["assets/images/gallery/login6.jpg","assets/images/gallery/login4.jpg","assets/images/gallery/login5.jpg", "assets/images/gallery/login3.jpg", "assets/images/gallery/login2.jpg", "assets/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
                });
