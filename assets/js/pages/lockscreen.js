$(function() {
       ...
       if( $('#slide-cb').attr('checked') ) {
            ...
            {                
                $.backstretch(["assets/images/gallery/login6.jpg","assets/images/gallery/login4.jpg", "assets/images/gallery/login3.jpg", "assets/images/gallery/login2.jpg", "assets/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
                });
