   ...
   {   		
   	...
   	function infoMenu(data)
   	{
   		$.ajax({
            ...
            var publicacion1 = "uaip/Cinicio/index";
            var publicacion2 = "uaip/Cinicio/valores";
            var publicacion3 = "uaip/Cproyecto/index";
            var publicacion4 = "uaip/Ccontacto/index";
            var publicacion5 = "uaip/Cinicio/dibujo";
            ...
            if(url!=null){
                ...
                {
                  texto = "1 Publicacion";
                }else if(url==publicacion2){
                  texto = "1-3 Publicaciones";
                }else if(url==publicacion3){
                  texto = "Lista de Publicaciones";
                }else if(url==publicacion4){
                  texto = "Contactenos";
                }else if(url==publicacion5){
                  texto = "Imagenes";
                }

                $('#url2').append("<option value='uaip/Cinicio/index'>"+texto+"</option>");


                if(url!=publicacion1){
                  $('#url2').append("<option value='"+publicacion1+"'>1 Publicacion</option>");
                }
                if(url!=publicacion2){
                  $('#url2').append("<option value='"+publicacion2+"'>1-3 Publicaciones</option>");
                }
                if(url!=publicacion3){
                  $('#url2').append("<option value='"+publicacion3+"'>Lista de Publicaciones</option>");
                }
                if(url!=publicacion4){  
                  $('#url2').append("<option value='"+publicacion4+"'>Contactenos</option>");
                }
                if(url!=publicacion5){  
                  $('#url2').append("<option value='"+publicacion5+"'>Imagenes</option>");
                }
                ...
                <div class="modal-body">
                  ...
                  <div class="row tab">
                    ...
                    <div class="col-md-8">
                      ...
                      <select name="url2" id='url2' class="form-control">
                        </select>
                    </div>
                  </div>
                  <div class="row tab">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <ul>
                        ...
                        <li>Imaganes : uaip/Cinicio/Vdibujos</li>
                        <li>Lista de Publicaciones: uaip/Cproyecto/index</li>
                        <li>Contactanos: uaip/Ccontacto/index</li>
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row tab">
                        ...
                        <div class="col-md-8">
                            <input type="file" name="fleImagen1" id="fleImagen1" multiple>
                            <img src="" id="preview1" width='100px'>
                        </div>
                    </div>
                    <div class="row tab">
                        <div class="col-md-4 titulos">
