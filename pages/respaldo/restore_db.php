...
<BODY 
	...
	<center><h1>La base de datos del sistema ha sido actualizada, <br>por lo tanto se redireccionara en 30 segundos</h1></center><br>
	<strong><center><p>Usuario/contraseña equivocado. Acceso denegado.</p></center>
<?php
			echo( "</strong><br><br><hr><center><small>" );
			setlocale( LC_TIME,"spanish" );
...
<BODY 
	...
	<p> Esta página será redireccionada en 30 segundos!</p>
	<center><h1>La base de datos del sistema ha sido actualizada</h1></center><br>
	<strong>
<?php
	@set_time_limit( 0 );
...
##///<meta http-equiv='refresh' content='30; url=backup.php'>;
		}
	}
?>
